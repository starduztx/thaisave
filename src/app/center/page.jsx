    ...
    <div className="min-h-screen bg-gray-50 font-sans text-gray-900 pb-10">
      ...
      <nav className="bg-[#1E3A8A] text-white w-full shadow-md sticky top-0 z-50">
        <div className="w-full px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium">
            <span className="text-yellow-400 font-bold border-b-2 border-yellow-400 pb-1 cursor-default">ส่วนกลาง/ศูนย์ช่วยเหลือ</span>
      ...
      <main className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-2xl font-bold text-gray-800">จัดการเคส</h3>
          <button className="bg-white border border-gray-300 px-4 py-1.5 rounded shadow-sm text-sm font-medium hover:bg-gray-50 text-gray-700">
            จัดการเคส
          </button>
        </div>
